...
export class MySubClassedDexie extends Dexie {
  ...
  constructor() {
    ...
    this.version(1).stores({
      ...
      // 'id, _id, href, active, hasThemeImage, image, name, customStyle, *createdAt, *updatedAt',
    });
    this.version(1).stores({
      specialitiesBrowserTable: "id++",
      // 'id, _id, specialities, description, image, image, imageId, users_id, *createdAt, *updatedAt',
    });
  }
}
