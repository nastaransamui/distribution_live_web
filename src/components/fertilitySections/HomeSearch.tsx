...
const HomeSearch: FC = (() => {
  ...
  return (
    <Fragment>
      <section className="banner-section-fourteen" style={muiVar}>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div
                ...
                data-aos="fade-up"
              >
                <h1 className="text-white">The Best Solutions, Experts and Care For Your Pregnancy</h1>
                <div className="banner-btns-fourteen">
                  <Link href="" className={`btn  ${widthMax480 ? '' : 'me-2'}`} onClick={(e) => {
                    e.preventDefault()
                    setShowFilter(!showFilter)
                  }}>
                    Meet Our Specialist
                  </Link>
                  <Link href="" className="btn" onClick={(e) => {
                    e.preventDefault()
                    setShowFilter(!showFilter)
                  }}>
                    Schedule a Call
              ...
              <Grid
                container
                sx={{
                  minWidth: { lg: `550px !important`, md: `560px !important` },
                }}
              ...
              >
                ...
                >
                  <Grid container spacing={{ lg: 1, xl: 1, md: 1, sm: 2, xs: 1 }}>
                    <Grid size={{ xl: 6, lg: 6, md: 6, sm: 6, xs: 12 }}>
                      ...
                      <TextField
                        ...
                        value={keyWord}
                        fullWidth
                        sx={{ mt: { xl: 1, lg: 1, md: 1, sm: 2, xs: 3 }, mb: { xl: 1, lg: 1, md: 1, sm: 2, xs: 0 } }}
                        size="small"
                        slotProps={{
                          inputLabel: {
                            shrink: keyWord !== ''
                  ...
                  <Grid size={12} className="form-search-btn">
                    <FormControl fullWidth
                      id="buttons_cosmetic"
                    ...
                    >
                      <Button
                        sx={{
                          mb: { xl: 1.5, lg: 1.5, md: 2, sm: 2, xs: 2 },
                          mt: { xl: 1.5, lg: showFilter ? 6 : 1.5, md: 2, sm: 2, xs: 2 },
                          float: 'right',
            ...
            <div className="col-lg-6">
              <div className="banner-img banner-img-fourteen aos" data-aos="fade-up">
