...
import ProfileSetting from '@/components/PatientDashboardSections/ProfileSetting';
...
const ProfileSettingPage: NextPage = (props: any) => {
  ...
  return (
    <>
      ...
      <BreadCrumb subtitle='Profile Settings' title='Profile Settings' currentPath={props.currentPath} />
...
export default connect((state: AppState) => state)(ProfileSettingPage);