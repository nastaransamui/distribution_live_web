...
import Invoices from '@/components/PatientDashboardSections/Invoices';
...
const InvoicePage: NextPage = (props: any) => {
  ...
  return (
    <>
      ...
      <BreadCrumb subtitle='Invoices' title='Invoices' currentPath={props.currentPath} />
...
export default connect((state: AppState) => state)(InvoicePage);