...
import ClinicalSignsHistory from '@/components/PatientDashboardSections/ClinicalSignsHistory';
...
const ClinicalSignsHistoryPage: NextPage = (props: any) => {
  ...
  return (
    <>
      ...
      <BreadCrumb subtitle='Clinical Signs History' title='Clinical Signs History' currentPath={props.currentPath} />
...
export default connect((state: AppState) => state)(ClinicalSignsHistoryPage);