...
import Dependent from '@/components/PatientDashboardSections/Dependent';
...
const DependentPage: NextPage = (props: any) => {
  ...
  return (
    <>
      ...
      <BreadCrumb subtitle='Dependent' title='Dependent' currentPath={props.currentPath} />
...
export default connect((state: AppState) => state)(DependentPage);