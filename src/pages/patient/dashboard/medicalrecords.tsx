...
const MedialRecordPage: NextPage = (props: any) => {
  ...
  return (
    <>
      ...
      <BreadCrumb subtitle='Medical Records' title='Medical Records' currentPath={props.currentPath} />
...
export default connect((state: AppState) => state)(MedialRecordPage);