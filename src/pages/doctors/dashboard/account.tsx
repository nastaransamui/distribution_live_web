...
import Accounts from '@/components/DoctorDashboardSections/Accounts';
...
const AccountPage: NextPage = (props: any) => {
  ...
  return (
    <>
      ...
      <BreadCrumb subtitle='Accounts' title='Accounts' currentPath={props.currentPath} />
...
export default connect((state: AppState) => state)(AccountPage);