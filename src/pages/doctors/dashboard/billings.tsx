...
import PatientBillingRecords from '@/components/shared/PatientBillingRecords';
import BillingsPageWrapper from '@/components/shared/BillingsPageWrapper';
const BillingsPage: NextPage = () => {
...
export default connect((state: AppState) => state)(BillingsPage);