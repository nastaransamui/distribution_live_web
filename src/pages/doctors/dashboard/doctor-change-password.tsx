...
import ChangePassword from '@/components/PatientDashboardSections/ChangePassword';
...
const ChangePasswordPage: NextPage = (props: any) => {
  ...
  return (
    <>
      ...
      <BreadCrumb subtitle='Change Password' title='Change Password' currentPath={props.currentPath} />
...
export default connect((state: AppState) => state)(ChangePasswordPage);