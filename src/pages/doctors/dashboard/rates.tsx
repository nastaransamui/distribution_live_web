...
import Rates from '@/components/DoctorDashboardSections/Rates';
...
const RatesPage: NextPage = (props: any) => {
  ...
  return (
    <>
      ...
      <BreadCrumb subtitle='Rates' title='Rates' currentPath={props.currentPath} />
...
export default connect((state: AppState) => state)(RatesPage);