...
import Appointment from '@/components/DoctorDashboardSections/Appointment';
...
const AppointmentsPage: NextPage = (props: any) => {
  ...
  return (
    <>
      ...
      <BreadCrumb subtitle='Appointments' title='Appointments' currentPath={props.currentPath} />
...
export default connect((state: AppState) => state)(AppointmentsPage);