...
const AddPrescriptionPage: NextPage = (props: any) => {
  ...
  return (
    <>
      ...
      <BreadCrumb subtitle='Add prescription' title='Add prescription' currentPath={props.currentPath} />
      <div className={`content ${homeSideBarOpen ? 'content-padding-open' : 'content-padding-close'}`} style={muiVar}>
        <div className="container-fluid">
          <div className="row">
            <PrescriptionPage pageType="add" userType='doctor' />
          </div>
        </div>
      </div>
      <DashboardFooter />
...
export default connect((state: AppState) => state)(AddPrescriptionPage);