...
import MyPtients from '@/components/DoctorDashboardSections/MyPtients';
...
const MyPatientsPage: NextPage = (props: any) => {
  ...
  return (
    <>
      ...
      <BreadCrumb subtitle='My Patients' title='My Patients' currentPath={props.currentPath} />
...
export default connect((state: AppState) => state)(MyPatientsPage);