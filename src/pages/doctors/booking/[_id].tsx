...
export const getServerSideProps: GetServerSideProps = wrapper.getServerSideProps(
  (store) => async (ctx) => {
    try {
      //Get single doctor
      // const docJson = await fetch(`${process.env.NEXT_PUBLIC_adminUrl}/methods/findUserById`, {
      //   method: 'POST',
      //   body: JSON.stringify({ _id: ctx?.query?._id }),
      //   headers: {
...
export default connect((state: AppState) => state)(Booking);