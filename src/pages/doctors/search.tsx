...
import SearchDoctorSection from '@/components/SearchDoctorSections/SearchDoctorSection';
  ...
  return (
    <>
      ...
      <div className="main-wrapper" id="scrollableDiv">
        <BreadCrumb title='Search Doctors' subtitle='Search Doctors' currentPath={props.currentPath} />
        <SearchDoctorSection />
...
export default connect((state: AppState) => state)(SearchPage);