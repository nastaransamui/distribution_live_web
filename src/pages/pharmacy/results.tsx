...
import ResultLeft from '@/components/PharmacySections/ResultLeft';
import ResultMain from '@/components/PharmacySections/ResultMain';
...
export default connect((state: AppState) => state)(ResultPage);