...
import HomeSearch from '@/components/PharmacySections/HomeSearch';
import SearchSection from '@/components/PharmacySections/SearchSection';
import LookingFor from '@/components/PharmacySections/LookingFor';
...
export default connect((state: AppState) => state)(PharmacyPage);