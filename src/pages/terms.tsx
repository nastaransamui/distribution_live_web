...
import TermsDetails from '@/components/TermsSections/TermsDetails';
...
const TermsPage: NextPage = (props: any) => {
  ...
  return (
    <>
      ...
      <BreadCrumb title='Terms & Condition' subtitle='Terms & Condition' currentPath={props.currentPath} />
...
export default connect((state: AppState) => state)(TermsPage);